...
print("Un nombre au hasard avec la loi binomiale : "+tirage_binomial(n, p))

print("Un nombre au hasard entre -10 et 10 : "+alea_entier(min, max))

print("Un nombre au hasard entre -5 et 5 avec la loi uniforme : "+tirage_uniforme(-5, 5))
...
print("Un nombre au hasard avec la loi exponentielle de paramètre 1 : "+tirage_expo(1))

print("Un nombre au hasard avec la loi normale de paramètre 0 et 1 : "+tirage_normale(0, 1))

print("Renvoie une liste d’entiers de 100 à 103 avec un pas de 0,5 : "+intervalle(100, 103, .5))

ListeTest=[1,2,3,4,5,6,1,2,3,4,1,2,3]
EffecTest=[1,2,3,4,5,6,7,8,9,1,2,3,4]
print(ListeTest)
print("Compte et range la liste ci-dessus : "+compte(ListeTest))
...
variance(xi, ni='optionnel'):

ecartype(xi, ni='optionnel'):
