...
def test_listes():
    ...
    print("On affiche un polynome à partir d'une liste ",affiche_poly([1,1,1]))
...
def test_stats_proba():
    ...
    print("Un nombre au hasard avec la loi binomiale de 2 parmi 5: ",tirage_binomial(5, 2))
    ...
    EffecTest=[1/55,2/55,3/55,4/55,5/55,6/55,7/55,8/55,9/55,1/55,2/55,3/55,4/55]
...
def test_repere():
    ...
    repere.trace_rectangle(1,1,8,4,couleur='noir', taille = 4, remplissage='jaune')
