...
class Runner:
    def __init__(self):
        if 'HOMESHARE' in os.environ:
            user_dir = os.path.join(os.environ['HOMESHARE'],'python')
        else:
            user_dir = os.path.join(os.environ['USERPROFILE'],'python',)
        get_workbench().set_default("run.working_directory", user_dir)
