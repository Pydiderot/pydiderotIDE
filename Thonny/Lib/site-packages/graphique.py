...
class Fenetre_graphique(Canvas):
...
def trace_segment(x1, y1, x2, y2, couleur='black', taille=2):
    ...
    parametres optionels: couleur = 'black', taille = 2"""
...
def trace_rectangle(x1,y1,x2,y2, couleur='black', taille=2, remplissage='yellow'):
    """trace un segment entre (x1, y1) et (x2, y2).
    parametres optionels: couleur = 'black', taille = 2, remplissage='yellow'"""
...
def creer_fenetre(titre = "Repère mathematique", xmin=-10, xmax=10, ymin=-10, ymax=10, fond = 'white', axes = True):
    """Initialise l'object fenetre graphique. Ne l'affiche pas.
    Les parametres et leurs valeurs par default son:
    titre = "Repère mathematique", xmin=-10, xmax=10, ymin=-10, ymax=10, fond = 'white', axes = True"""


    root = Tk()       # on crée la fenêtre
    root.title(titre) # on lui donne un titre
    graph = Fenetre_graphique(root,xmin = xmin, xmax=xmax, ymin = ymin, ymax=ymax,
