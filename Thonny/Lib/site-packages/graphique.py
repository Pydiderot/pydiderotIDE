...
def axes():
    ...
    #pygame.font.Font.render(str(ymax), True, couleur, background=None)
    #ligne ci-dessus : à finir (afficher xmax et ymax et tant qu'à faire créer une fonction "texte()"...
    pygame.display.update()
