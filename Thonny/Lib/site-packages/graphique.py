...
def trace_cercle(x, y, rayon=5, epaisseur=0, couleur='bleu'):
    ...
    Arguments:
        ...
        couleur (str, tuple, optionnel): Couleur du cercle (bleu par défaut)
    """
    couleur = rgb(couleur)
...
def trace_point(x, y, couleur='bleu'):
    ...
    Arguments:
        ...
        couleur (:ref:`couleur`, optionnel): Couleur du point (bleu par défaut)
    """
    couleur = rgb(couleur)
...
def trace_rectangle(x, y, largeur, hauteur, couleur='bleu', epaisseur=1):
    ...
    Arguments:
        ...
        couleur (:ref:`couleur`, optionnel): Couleur du rectangle (``bleu`` par défaut)
