...
#
"""
Module avec les fonctions de la classe de Seconde sur la réforme de 2018 pour le lycée diderot (marseille).
On prend comme fichier de départ le module de l'irem d'Amiens (un lien ?)
"""
...
import matplotlib.pyplot as rr
import numpy as np
import builtins
from scipy.stats import norm
"""
Cela fait BEAUCOUP d'import. Tous utiles ?
Et une fonction est un verbe en général.

"""
print ("...module Seconde actif....")
pi=math.pi
AlphabetAP=" ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789.,:;!?&àâéèêëîïù#'(-_){}[]|\@=+°§$<>%*/" #largement incomplet. A completer ?

# -------------------------------------------------------
#    FONCTIONS ENTREE - SORTIE
# -------------------------------------------------------

def demander_texte(prompteur):
    """
...
def demander_nombre(prompteur):
    ...
    # DANGER : il n'y a pas de test d'erreur. Que se passe-t-il si un caractère n'est pas un nombre ?


# -------------------------------------------------------
#    FONCTIONS MATHEMATIQUES SUR LES ENTIERS
# -------------------------------------------------------
...
def binomial(n,p): # Pas dans la bonne partie
    """
    n et p sont deux entiers.
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Retourne le coefficient binomial p parmi n, c'est à dire le nombre de chemins de l’arbre réalisant p succès pour n répétitions.
    Ou, et c'est la même chose : le choix de p éléments parmi n. 
    """
    if p<=n :
...
def sans_virgule(x): # En français. Utilité ? Concept de la partie entière difficile au lycée pour les nombres négatifs. Faire une fonction pour prendre la partie sans la virgule ?
    """
    x est un nombre decimal.
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Retourne la partie entiere du nombre x sans sa partie décimale. Ex : -2.5 devient -2
    """
    return int(x)
...
def ln(x):
    ...
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Retourne l'image du nombre x par la fonction logarithme NEPERIEN.
    """
    return math.log(x)
def log(x):
    """
    x est un nombre strictement positif.
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Retourne l'image du nombre x par la fonction logarithme DECIMAL.
    """
    return math.log10(x)
...
def cos_radian(angle): #Les mesures des angles en radian dès la seconde : irrealiste !
    """
...
def choice(list): #FR ! notion de liste au lycée ?
    """
    list est une liste.
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
def intervalle(debut,fin,pas='optionel'): #OK !
    """
...
def range(debut,fin='optionel',pas='optionel'): # A supprimer !
    """
    debut, fin et pas sont des entiers.
...
def fich2chaine(fichier='optionel'): #Utile !
    """
...
def codeAAP(caract): #inutile et dangeureux ! bosser avec l'utf-8 (ou autre)!
    """
...
def listeRand(n): #Inutile à faire faire aux élèves justment
    """
    n est est un nombre
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
def listeRandint(min,max,n): #Inutile à faire faire aux élèves justment
    """
    min est un nombre
    max est un nombres
    n est est un nombre
