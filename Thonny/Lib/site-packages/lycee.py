...
def pgcd(a,b): #n'a RIEN à faire dans les entrées sorties !!
    """
...
# -------------------------------------------------------
#Faire une sous partie nombres entiers ?
def puissance(a,n): #il faut ajouter la fonction carre
    """
...
def cos(angle): #Les mesures des angles en radian dès la seconde : irrealiste !
    """
...
def cosD(angle): #Mieux mais pas assez explicite : cos_degre et cos_radian serait mieux comme nom de fonction
    """
...
def sqrt(x): #mettre le nom en FRANCAIS
    """
...
def floor(x): # En français. Utilité ? Concept de la partie entière difficile au lycée pour les nombres négatifs. Faire une fonction pour prendre la partie sans la virgule ?
    """
